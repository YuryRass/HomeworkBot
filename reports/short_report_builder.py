"""Модуль по созданию короткого отчета по выполнению лаб. работ студентами"""
import json
...
class ShortReportBuilder(BaseReportBuilder):
    ...
    def build_report(self) -> None:
        # инициализируем сначала короткий отчет базовыми значениями
        super().build_report()
        ...
        for student in students:
            ...
            if row > 1:
                ...
                for work in home_works:
                    ...
                    tasks_in_lab = len(work.tasks) # кол-во заданий в лаб. работе
                    tasks_completed = 0 # кол-во выполненных заданий в лабе

                    # tasks_completed / tasks_in_lab - отношение выполеннных заданий
