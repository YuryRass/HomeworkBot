...
[@Грокаем_Python_через_разработку_проекта](https://stepik.org/course/138391)
на платформе [@Stepik](https://stepik.org), предназначенная для автоматизированной проверки
лабораторных или домашних работ, написанных на языке программирования Python, студентов,
состоящих в определенном телеграм-чате,
